...
//
// The hue comes from the title, so a book always gets the same cover and two
// books next to each other rarely get the same one.
...
export function placeholderCover({ title, author }) {
